...
function renderTop(){var t=DATA||{},k=t.kpis||{};byId('topmeta').innerHTML='Jat · '+num(k.studios)+' studios<br>'+num(k.committed)+' committed / '+num(k.capacity)+' capacity · '+num(k.bookingsOpen)+' open stays · as of '+esc(t.asOf||'-');}
