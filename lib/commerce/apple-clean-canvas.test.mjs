...
test('obsolete waves overlay does not mount over the member shell', () => {
  assert.doesNotMatch(html, /src="\/commerce-waves\.js"/);
  assert.doesNotMatch(html, /href="\/commerce-waves\.css"/);
});
...
test('home renderer reads the Central-backed dashboard', () => {
