...
export const SENSITIVE_LOG = /bearer\s+[a-z0-9._\-]+|niaOpsToken|STAFF_TOKEN|password|otp|\+91[6-9]\d{9}|[a-z0-9._%+\-]+@[a-z0-9.\-]+\.[a-z]{2,}/i;
...
export function redactClientLog(value) {
  ...
  if (typeof value === 'object') {
    ...
    for (const [k,v] of Object.entries(value)) {
      if (/token|bearer|password|otp|phone|email|authorization|niaOpsToken|staffToken/i.test(k)) out[k] = '[redacted]';
