...
export function staffAction(s,actor,body,time) {
  ...
  if (body.action === 'verify_payment') {
    ...
    if (action === 'collect_at_stop' && (String(body.pickupCode).toUpperCase() !== o.pickupCode || !['verified','reconciled'].includes(o.payStatus))) fail('pickup_code_and_verified_payment_required',409);
