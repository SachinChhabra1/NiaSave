...
export function publicOrder(o) {
  return Object.fromEntries(['id','memberId','pickupCode','lines','amount','due','paid','payStatus','status','createdAt','updatedAt','expiresAt','location','fulfillment','payment','refund','preview'].map(k => [k,o[k]]));
}
