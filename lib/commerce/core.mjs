...
export function publicOrder(o) {
  return Object.fromEntries(['id','memberId','pickupCode','lines','amount','due','paid','payStatus','status','createdAt','updatedAt','expiresAt','location','fulfillment','payment','refund','preview','test'].map(k => [k,o[k]]));
}
