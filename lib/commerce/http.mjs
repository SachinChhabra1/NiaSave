...
import {passwordAuthEnabled,passwordSessionActor,memberPasswordLogin,memberSessionCookie,passwordCatalogue} from './member-password.mjs';
...
export async function commerceHttp(req,res,path,getStaff) {
  ...
  if(!preview && passwordAuthEnabled()){
    if(req.method==='POST' && path==='/auth/login'){
      const result=memberPasswordLogin(body,req,time);
