...
export async function commerceHttp(req,res,path,getStaff) {
  ...
  if (!preview && !liveReady() && !(durableOrdersReady() && (passwordActorNow || path.startsWith('/staff/')))) return send(503,{error:'commerce_not_configured',message:'Ordering is not open yet.'});
