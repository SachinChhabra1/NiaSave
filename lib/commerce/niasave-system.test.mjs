...
test('X0 tokens lock type, color, radius, touch, keep-green', () => {
  for (const token of ['--nia-ground-dark:#0B0B0C','--nia-ground-light:#F4F2EE','--nia-ink:#111112','--nia-accent:#0056B8','--nia-keep:#1B7A4A','--nia-radius:24px','--nia-touch:52px','--nia-type-body:17px']) {
