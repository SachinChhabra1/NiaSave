...
// Never selected by a browser key: only a fresh Central-signed smoke grant.
export const SAVE_SMOKE_BOOK_KEY='niasave-save-production-smoke-v1';
export const saveSmokeRepository=createSaveRepository({durable:hasDurableStore,
  load:()=>loadExistingRuntimeState(SAVE_SMOKE_BOOK_KEY,null),
  initialize:()=>loadRuntimeState(SAVE_SMOKE_BOOK_KEY,emptySaveBook()),
  save:(value,version)=>saveRuntimeState(SAVE_SMOKE_BOOK_KEY,value,version)});
