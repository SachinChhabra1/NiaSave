...
test('every deployed desk and clean alias challenges before serving a desk document',async()=>{
  for(const page of ['ops','polo','desk','2para','bison','bison-data','bison-clocks','bison-contracts','bison-collections','bison-nests','bison-studios','pickup','recon','predict','hub','next','cash','source','inventory','ageing','po','dispatch','invoice','biker','vendors','payout','save-desk','tanot/index']) {
