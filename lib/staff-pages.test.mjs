...
test('login assets and application authentication routes stay available to obtain a credential',async()=>{
  for(const path of ['/staff.js','/staff.css','/save-desk-ui.css','/staff-entry.js','/v1/staff/login','/v1/staff/me','/api/bison/tower','/api/service/member','/commerce.html','/'])assert.equal(await staffPageAccess(request(path)),undefined);
});
