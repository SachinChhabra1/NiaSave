...
ok("Bison pages lock Polo Bison Tanot All products", bisonPages.every(file => {
  ...
  return /<div class="kicker">Bison<\/div>/.test(html) && /href="\/ops.html">Polo</.test(pageRail) && /href="\/bison.html">Bison</.test(pageRail) && /href="\/tanot\/">Tanot</.test(pageRail) && /href="\/desk.html">All products</.test(pageRail) && !/Sikh|Jat|Dogra|Assam Rifles/.test(pageRail);
}));
