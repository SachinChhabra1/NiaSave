...
const required = ['function entryHomepage', 'apple-home', 'apple-unit', 'apple-rail', 'mesha-rail', 'studio-bunk-lockers.jpg', "data-action=\"live\"", "['shop','save'", "A Nest near work.", 'Extra shifts', 'Shop less', "Money home.", "${t('Live')}"];
...
if (snippet.includes('An upskilled job.') || snippet.includes('Shop at wholesale rates.')) throw new Error('homepage must keep founder mock promise titles');
