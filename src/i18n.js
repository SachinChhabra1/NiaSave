...
const shared = {
  en: {
    ...
    fever: "Bag ₹500 this month → fever day free.", search: "Search salt, oil, Parle-G",
    ...
    noPack: "No pack found. Try salt, oil, or Parle-G.", bag: "Bag", atKirana: "at kirana",
    ...
    language: "Language", close: "Close", soapWeek: "Soap for the week",
  ...
  hi: {
    ...
    noPack: "कोई पैक नहीं मिला। नमक, तेल या पारले-जी खोजें।", bag: "बैग", atKirana: "किराना में",
    ...
    language: "भाषा", close: "बंद करें", soapWeek: "हफ़्ते भर का साबुन",
  ...
  kn: {
    ...
    noPack: "ಪ್ಯಾಕ್ ಸಿಗಲಿಲ್ಲ. ಉಪ್ಪು, ಎಣ್ಣೆ ಅಥವಾ ಪಾರ್ಲೆ-ಜಿ ಹುಡುಕಿ.", bag: "ಬ್ಯಾಗ್", atKirana: "ಕಿರಾಣಿಯಲ್ಲಿ",
    ...
    language: "ಭಾಷೆ", close: "ಮುಚ್ಚಿ", soapWeek: "ವಾರದ ಸಾಬೂನು",
  ...
  ta: {
    ...
    noPack: "பொருள் கிடைக்கவில்லை. உப்பு, எண்ணெய் அல்லது பார்லே-ஜி தேடுங்கள்.", bag: "பை", atKirana: "கிரானாவில்",
    ...
    language: "மொழி", close: "மூடு", soapWeek: "ஒரு வாரத்திற்கான சோப்பு",
