...
export function Sidebar({ items, active, onSelect }) {
  ...
  return (
    <aside className="sidebar" aria-label="Dogra Unit navigation">
      <div className="product-brand">
        <span className="product-mark"><img src="/assets/nia-mark-square.png" alt="" /></span>
        <span><strong>Dogra Unit</strong><small>Enterprise demand</small></span>
      </div>
