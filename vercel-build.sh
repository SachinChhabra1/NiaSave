...
cp -f commerce.html commerce.css commerce.js commerce-owner.js commerce-passkeys.js commerce-i18n.js commerce-books.js commerce-services.js commerce-plan.js commerce-earn-map.js commerce-categories.js commerce-ops.js dist/
