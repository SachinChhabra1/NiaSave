...
cp -f commerce.html commerce.css commerce.js commerce-i18n.js commerce-books.js commerce-earn-map.js commerce-categories.js commerce-ops.js commerce-plan.js dist/
mkdir -p dist/commerce-locales/member-updates
cp -f commerce-locales/*.js dist/commerce-locales/
cp -f commerce-locales/member-updates/*.js dist/commerce-locales/member-updates/
